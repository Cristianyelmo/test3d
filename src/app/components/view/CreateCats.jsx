...
export default function CreateCats() {
  ...
  transition-opacity duration-500 ease-in-out`}
        ...
        <button className="neon-border-volver p-4 mr-4 mb-4" onClick={Volver}>
          volver
        </button>
        ...
        <div className="flex flex-col items-center lg:items-start">
          <div className="space-y-4 ml-10 mt-2 lg:mt-0 ">
            <div
              className={`relative mb-10  ${errorMessage == "" && "hidden"}`}
            >
            ...
            <button
              className="neon-border-crear p-4 mt-10"
              onClick={CreatedArray}
            >
              crear
            </button>
            <div></div>
