...
export default function Presentation() {
  ...
  return (
    ...
    >
      <div
        className={`bg-black z-30 h-full w-full absolute opacity-0 ${presentationanimation}`}
      ></div>
      ...
      <h1 className="neon-text z-10 absolute text-4xl lg:text-5xl lg:top-[450px]  h-[600px] bottom-[-320px]  bottom-0 left-1/2 transform -translate-x-1/2 mb-4  presentation-new2 ">
        PetMaker
      </h1>
